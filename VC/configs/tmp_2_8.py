...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_exp.add_argument('--name', type=str, default='2_8_512_2dfrf',
        ...
        g_train.add_argument('--gpu_ids', type=str, default=[0,1,2,3], help='gpu ids: e.g. 0  0,1,2, 0,2, -1 for CPU mode')
        ...
        g_train.add_argument('--batch_size', type=int, default=100, help='input batch size')
        g_train.add_argument('--learning_rate', type=float, default=1e-3, help='adam learning rate')
        g_train.add_argument('--schedule', type=int, nargs='+', default=[20, 100], help='Decrease learning rate at these epochs.')
        g_train.add_argument('--rf_schedule', type=int, nargs='+', default=[120, 150], help='Decrease learning rate at these epochs.')
        g_train.add_argument('--sigma_schedule', type=int, nargs='+', default=[20, 100], help='Decrease learning rate at these epochs.')
        ...
        g_train.add_argument('--refine_epoch', type=int, default=90, help='heatmaps target weight')
