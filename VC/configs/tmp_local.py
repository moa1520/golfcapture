...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_exp.add_argument('--name', type=str, default='test',
        ...
        g_train.add_argument('--gpu_ids', type=str, default=[0,1], help='gpu ids: e.g. 0  0,1,2, 0,2, -1 for CPU mode')
        g_train.add_argument('--use_multi_gpus', default=False, help='load pretrained model')
        ...
        g_train.add_argument('--schedule', type=int, nargs='+', default=[35, 100], help='Decrease learning rate at these epochs.')
        g_train.add_argument('--rf_schedule', type=int, nargs='+', default=[110, 150], help='Decrease learning rate at these epochs.')
        g_train.add_argument('--sigma_schedule', type=int, nargs='+', default=[10, 25], help='Decrease learning rate at these epochs.')
        ...
        g_train.add_argument('--refine_epoch', type=int, default=0, help='heatmaps target weight')

        g_train.add_argument('--input_size', type=int, default=512, help='input image size')
        ...
        g_train.add_argument('--num_blocks', type=int, default=8, help='heatmaps target weight')
        g_train.add_argument('--num_channels', type=int, default=64, help='heatmaps target weight')
        g_train.add_argument('--aug_blur', default=False, help='heatmaps target weight')

        # g_train.add_argument('--freq_print', type=int, default=100, help='freqency of the printing progress')
        # g_train.add_argument('--freq_plot', type=int, default=100, help='freqency of the plotting result')
