...
from models.model_resnet_heatmap import Plan1, Plan2, Plan1_concat, Plan1_repeat
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_size', type=int,
                        help='image size of input', default=512)
    ...
    parser.add_argument('--heatmap_size', type=int,
                        help='the size of heatmap', default=128)
    parser.add_argument('--save_folder', type=str,
                        help='divided frame numbers', default='checkpoints/plan1_repeat')
    parser.add_argument('--continue_train', type=bool,
                        help='continue training', default=True)
